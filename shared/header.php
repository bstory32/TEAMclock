      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php"><strong>TEAM</strong>clock.co</a>
          </div>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="project-overview.php">Project Overview</a></li>
                  <li><a href="manage-project.php">Manage Projects</a></li>
                  <li class="divider"></li>
